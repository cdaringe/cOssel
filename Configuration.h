...
#define STRING_CONFIG_H_AUTHOR "(cdaringe, cOssel)" // Who made the changes.
...
// Autoleveling Z probe
//#define Z_PROBE_TYPE 2  //comment out if not equipped (in development)
//1 - mechanical switch
//2 - reflective sensor
